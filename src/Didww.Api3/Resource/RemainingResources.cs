...
public class Requirement : BaseResource
{
    ...
    [JsonProperty("area_level")] public AreaLevel? AreaLevel { get; set; }

    [JsonProperty("proof_types")] public List<ProofType>? ProofTypes { get; set; }
    [JsonProperty("supporting_document_templates")] public List<SupportingDocumentTemplate>? SupportingDocumentTemplates { get; set; }
}
